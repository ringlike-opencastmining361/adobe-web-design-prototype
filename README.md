...
2. Find the file named `config.js`.
3. Open it with Notepad or any text editor.
4. Change the values you see. For example, you can change the project name or the starting page.
5. Save the file.
...
- Make sure you opened the `index.html` file, not another file.
- Check that all files are in the same folder. Do not move them around.
...
No. You just unzip the folder and open the HTML file.
...
Yes. The prototype uses HTML, CSS, and JavaScript files. You can edit them with any text editor. But you do not need to.

**Q: Is this the real Adobe software?**
No. This is a prototype. It shows how a design might look. It is not the full Adobe product.
...
Yes. The files are hosted on GitHub. They are plain text and HTML files. They do not contain any harmful code.
...
- `index.html` – The main file you open in your browser.
- `config.js` – Settings for the prototype.
- `assets/` – A folder with images, styles, and scripts.
- `pages/` – A folder with different screen layouts.
- `README.txt` – A text file with basic instructions.
...
- Edit the `styles.css` file in the `assets` folder to change colors and fonts.
- Edit the `scripts.js` file to change how buttons work.
